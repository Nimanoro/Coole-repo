  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <button className="bg-white p-2 rounded-full shadow-md" onClick={() => navigate("/dashboard")}>
        ...
        <h2 className="text-lg text-black font-bold">برنامه های در حال اجرا</h2>
      ...
      <div className="flex gap-3 mb-4">
        ...
        <button className="w-[123px] h-[36px] bg-green-600 text-white rounded-3xl shadow-md" onClick = {() => setSortBy("mostViewed")}>s
          <div className="flex items-center justify-center h-full gap-2">
            <span className="inline-block relative top-[1px]">
